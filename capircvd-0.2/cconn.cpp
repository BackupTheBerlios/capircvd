...
void CAPIConn::ConnectIt()
 ...
 WaitingforConnect=false;
 _cmsg CMSG1;
 CONNECT_RESP(&CMSG1,Appl_Id,MsgNr,PLCI,Reject,B1,B2,B3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
void CAPIConnDeflect::Connect(_cmsg *CMSG)
 ...
 PLCI=CONNECT_IND_PLCI(CMSG);
 _cmsg CMSG1;
 ALERT_REQ (&CMSG1, Appl_Id, 0, PLCI, NULL, NULL, NULL, NULL);
 MsgNr=CMSG->Messagenumber;
 setWaitforConnect();
 }
...
void CAPIConnDeflect::ConnectIt()
 ...
 INFO_REQ(&CMSG1,Appl_Id,0,PLCI,(unsigned char *)fac,(unsigned char *)fac+2,(unsigned char *)fac,(unsigned char *)fac,(unsigned char *)fac+4);
...
void CAPIConnVoice::Connect(_cmsg *CMSG)
 ...
 PLCI=CONNECT_IND_PLCI(CMSG);
 _cmsg CMSG1;
 ALERT_REQ (&CMSG1, Appl_Id, CMSG->Messagenumber, PLCI, NULL, NULL, NULL, NULL);
 MsgNr=CMSG->Messagenumber;
 setWaitforConnect();
 }
...
void CAPIConnFax::ConnectIt()
 ...
 CONNECT_RESP(&CMSG1,Appl_Id,MsgNr,PLCI,Reject,B1,B2,B3,NULL,NULL,buf,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
 }
...
void CAPIConnFaxpoll::ConnectActive(_cmsg *CMSG)
 ...
 SELECT_B_PROTOCOL_REQ(&CMSG2,Appl_Id,0,PLCI,4,4,5,NULL,NULL,buf);
